...
* implement auto-update system with UpdateChecker class and MainWindow integration (2d46ed53)
* add injectDarkModeCSS method for JS-based CSS injection (b8cd0557)
* implement CSS-based dark mode and add AppImage build script (ceaeaeeb)
* add desktop integration and autostart script (cb7c6529)
...
* remove unnecessary context menu check (ec1b0547)
* initRateWidget return early for debugging (9790c573)
* remove deprecated setUserStyleSheetUrl, use JS injection (933730b4)
* replace universal selector with specific elements for responsive design (8b555d9b)
* prevent crashes due to custom notification (dde6e024)
* improve notification handling (971820f5)
* Notification issue on gnome shell + minor improvements (#202) (86f27b98)
...
* update version to 5.1.0 and enhance changelog for build system migration and bug fixes (004863f3)
* remove force-bump-patch-version option from release configuration (a4a9fbcf)
* add cmake as a build snap dependency (3342c268)
* remove full width view toggle and related JavaScript injection (3e1c02a7)
* add rotateApps method to MoreApps and update lock screen to refresh app suggestions on show (8fde410d)
* remove custom spell check dictionary handling and related UI (8c0cdccf)
* switch to system hunspell dictionaries and remove compile-time dictionary handling (73d8c5f5)
* remove qmake pro file (547cd73d)
* improve qwebengine_convert_dict tool detection and update dictionary install path (f1dd35ee)
* update appdata with improved description, keywords, and 5.0.0 release notes (7cae83ed)
* update snapcraft build to use default override and improve icon handling (132aceec)
* clean up snapcraft build override formatting and indentation (2ebdac12)
* fix capitalization of Qt (#265) (c68a0e84)
* version bump to 4.16.3 (20eef260)
* version bump to 4.16.2 (ece2c555)
* release 4.16.1 (4fc0482f)
* version bump to 14.5.6 (91e1812d)
* bump version and update metadata (3ad375a1)
* update screenshot (93b98cb4)
* update screenshots (b0d74f70)
* bump version 4.15.3 (5afb8391)
* update svg icon text object to path (1ed232e7)
* update changelog (596980a9)
...
* remove non-existent libqt5positioning5-dev package (fd0cb6b6)
* build.yml use apt Qt, parallel build, upload artifact (d3a7217e)
